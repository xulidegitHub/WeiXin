...
#import "XLNetwork.h"
@implementation XLNetworkSampleModel
...
+ (instancetype)modelByTest
{
    ...
    XLNetworkSampleModel *model = [MTLJSONAdapter modelOfClass:XLNetworkSampleModel.class fromJSONDictionary:testData error:&error];
